...
if __name__ == "__main__":
    data_root = "home_path/Dataset/VOC_AUG/VOC2012"
    list_root = "home_path/SAGNN/lists/pascal/voc_sbd_train.txt"
    value_scale = 255
    ...
    train_data = SemData(split=3,shot=5, data_root=data_root,data_list=list_root,transform=train_transform)
    a = train_data[1]